...
# Macula covariate and phenotype files
plink_prefix_path = 'files/final_403_SHAPEIT_phased_IMPUTE2_imputed_filtered_variants_no_X'
expression_bed = 'files/macular_batch1.rnaseqc_tmm.expression.bed.gz'
covariates_file = 'files/macular_batch_1_eqtl_25_peers_10_genot_PCs_other_covariates.txt'
...
cell_type = 'RGC'
prefix = 'rgc_macula_0.1'
maf = 0.1

# Load interaction dataframe
interaction_df = pd.read_csv('files/cellTypeFractions_macula_big.class_071424.csv', index_col=0)
